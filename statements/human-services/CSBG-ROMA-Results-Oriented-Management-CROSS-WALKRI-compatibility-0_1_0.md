...
## How CROSS Satisfies the CSBG ROMA Framework

ROMA's Six National Goals are pre-specified at the statutory level before any grant period begins, functioning as CROSS's entry specification gate at the national program level. All CSBG-funded CAAs operate within this pre-specified outcome framework, which cannot be modified by individual agencies or states. This is the strongest possible form of CROSS's entry specification gate: the indicator domains are established by statute and federal regulation before any application, client intake, or service delivery occurs.

**Change obligation mode indicators:** The Six Goals function as Change obligation mode indicators at the population level. Goal 1 (economic self-sufficiency), Goal 2 (health), Goal 3 (children's school readiness), Goal 4 (housing stability), Goal 5 (organizational capacity), and Goal 6 (partnerships) each describe a population-level condition that CSBG-funded services are intended to shift. CROSS's Theory of Change hierarchy maps directly to this structure: CAA activities (service delivery) produce outputs (people served) that are intended to produce outcomes (changes in the six goal domains) contributing to the long-term goal of poverty reduction. CROSS's completion gate requires that agencies document outcome-level changes, not activity-level throughput, corresponding to ROMA's requirement that agencies report results within the Six Goals framework rather than reporting services delivered.

**Attestation gate and federal reporting:** The CSBG Annual Report submitted to states and aggregated to federal reporting constitutes a structured attestation requirement. CROSS's attestation gate requires that outcome claims be supported by a documented evidence corpus; the CSBG Annual Report is the formal instrument through which that corpus is assembled and verified. CROSS's Retroactive obligation mode applies to legacy service data that CAAs are required to maintain and report across multi-year program periods, where outcomes from prior years contribute to cumulative assessments of self-sufficiency or housing stability.

| ROMA Element | CROSS Provision |
|:--|:--|
| Six National Goals (pre-specified outcome domains) | Entry specification gate at statutory level; Change obligation mode indicator set |
| Goal 1: Economic self-sufficiency | Change obligation indicator; outcome tier of Theory of Change |
| Goal 2: Health | Change obligation indicator; outcome tier of Theory of Change |
| Goal 3: Children's school readiness | Change obligation indicator; outcome tier of Theory of Change |
| Goal 4: Housing stability | Change obligation indicator; outcome tier of Theory of Change |
| Goal 5: Community organization capacity | Build obligation mode; organizational identity and capacity documentation |
| Goal 6: Partnerships | Coherence disclosure; concurrent funding and partner documentation |
| CSBG Annual Report | Attestation gate; completion gate evidence corpus |
| Multi-year program tracking | Retroactive obligation mode; longitudinal outcome documentation |
