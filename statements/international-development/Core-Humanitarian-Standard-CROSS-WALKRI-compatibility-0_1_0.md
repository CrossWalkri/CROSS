...
The Core Humanitarian Standard on Quality and Accountability is the foundational accountability framework for the humanitarian sector. Its 2024 edition was developed through a global consultation with more than 4,000 contributors in 90 countries, coordinating among the CHS Alliance, Sphere, and Groupe URD. It is used by UN agencies, ICRC, and hundreds of national and international NGOs as the primary framework for organizational accountability to affected communities.

The CHS articulates nine commitments that describe what communities and people affected by crisis should be able to expect from humanitarian organizations:

1. Communities and people receive appropriate and relevant assistance.
2. Communities and people have access to the assistance they need.
3. Communities and people are not negatively affected and are more safe.
4. Communities and people know their rights and entitlements.
5. Communities and people have access to safe and responsive mechanisms to handle complaints.
6. Communities and people receive coordinated, complementary assistance.
7. Communities and people can expect improved assistance as organizations learn from experience and reflection.
8. Communities and people can expect that the organizations acting in their interests are managing resources effectively, efficiently, and ethically.
9. Communities and people can expect that the organizations assisting them are continuously improving.

Each commitment is accompanied by key actions (what organizations must do), organizational responsibilities (what management systems must enable), and quality criteria (how conformance is assessed). CHS verification is conducted by the CHS Alliance and involves a structured review of organizational systems against these criteria.

---

## Commitment 7: Learning and Adaptation

Commitment 7 requires that humanitarian organizations improve assistance based on systematic data collection, analysis, and evidence-informed decision-making. Its key actions include: monitoring activities and their effects, using findings for learning, sharing learning with communities and partners, and adjusting activities based on evidence of what is and is not working.

CROSS addresses Commitment 7 at the structural precondition level. Adaptation requires a measurement framework that was specified before implementation: without pre-specified indicators, baselines, and collection methodologies, there is no stable reference point against which to assess what has changed and what should be adjusted. CROSS's entry specification gate is the gate at which this framework is locked before implementation begins. The eleven-field indicator specification establishes the measurement architecture; the Theory of Change architecture with named causal links and assumptions establishes what the program believes will change and why; the gate-based evidence submission structure produces a rolling record of actuals against which learning claims can be assessed.
...
## Commitment 8: Effective and Ethical Resource Management
...
## Commitment 9: Continuous Improvement
...
## Commitments Outside Scope

Six of the nine CHS commitments address operational aspects of humanitarian response delivery that are outside the specification layer and therefore outside the scope of this statement.

| Commitment | Scope Assessment |
| :-- | :-- |
| 1. Appropriate and relevant assistance | Operational: concerns programme design and community needs assessment processes. Outside CROSS+WALKRI specification scope. |
| 2. Access to assistance | Operational: concerns targeting, inclusion, and distribution systems. Outside CROSS+WALKRI specification scope. |
| 3. Do no harm and safety | Operational: concerns safeguarding, protection mainstreaming, and risk management systems. Outside CROSS+WALKRI specification scope. |
| 4. Rights and entitlements awareness | Operational: concerns community information and communication systems. Outside CROSS+WALKRI specification scope. |
| 5. Complaint and feedback mechanisms | Operational: concerns accountability systems and community feedback channels. Outside CROSS+WALKRI specification scope. |
| 6. Coordinated and complementary assistance | Operational: concerns coordination with other organizations. CROSS Field 10 (institutional framework alignment) captures formal coordination framework declarations, but this does not constitute a coordination system. Partial relevance only. |
| 7. Learning and adaptation | In scope: see above. |
| 8. Effective and ethical resource management | In scope: see above. |
| 9. Continuous improvement | In scope: see above. |

---

## Full Nine-Commitment Mapping Table

| CHS Commitment | CROSS Provision | WALKRI Provision | Coverage |
| :-- | :-- | :-- | :-- |
| 1. Appropriate and relevant assistance | No direct provision | No direct provision | Outside specification scope |
| 2. Access to assistance | Population scope (Field 6) is adjacent but not equivalent | No direct provision | Outside specification scope |
| 3. Do no harm and safety | No direct provision | No direct provision | Outside specification scope |
| 4. Rights and entitlements | No direct provision | No direct provision | Outside specification scope |
...
2. Declare concurrent funding and co-financing arrangements in the obligation record at the entry gate, satisfying the financial transparency dimension of Commitment 8 at the specification layer.
...
Core Humanitarian Standard: https://www.corehumanitarianstandard.org/the-standard

CHS Alliance: chsalliance.org
