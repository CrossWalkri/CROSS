...
lens_tags:
  ...
  # US President's Emergency Plan for AIDS Relief Monitoring, Evaluation and Reporting; statutory under Leadership Act
---
...
This is consequential because MER's disaggregation requirements create a downstream conformance obligation: data submitted to DATIM that cannot be traced back to operationally defined intake instruments is vulnerable to audit findings. WALKRI closes this gap by requiring that the operational definitions be established at the intake design stage, before any data collection begins, making MER disaggregation traceable from submission back to the original instrument design.
