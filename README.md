...
| [Impact Management Norms](https://impactfrontiers.org/norms/) | Framework | n/a | n/a | n/a | Five Dimensions of Impact (What, Who, How Much, Contribution, Risk) |
...
|:--|:--|:--|
| USAID PIRS | CROSS eleven-field indicator spec satisfies all nine required PIRS elements | `USAID-PIRS-CROSS-WALKRI-compatibility-0_1_0.md` |
...
| [Impact Management Norms](https://impactfrontiers.org/norms/) | CROSS+WALKRI addresses all five IMP dimensions (What, Who, How Much, Contribution, Risk) as a structural consequence of conformance | `Impact-Management-Norms-CROSS-WALKRI-compatibility-0_1_0.md` |
...
| Packard Foundation MEL Guiding Principles | CROSS gate architecture structures Packard's monitoring and learning loop; WALKRI ensures intake field quality; CROSS gate rigor levels implement Packard's proportionality principle | `Packard-Foundation-MEL-CROSS-WALKRI-compatibility-0_1_0.md` |
